...
public class HekrWebSocket {
	...
	private static final String TAG = "HekrWebSocket";
    ...
    public static final int MSG_REC_UART_DATA = 16001;

    public HekrWebSocket(Handler handler, String tid, String user,String userAccessKey) {
    	this.recHandler = handler;
    	try {
    	   wsuri +=  tid + "/code/" + userAccessKey + "/" +user;
    ...
    public void sendDevCall(String tid,String msg) {
